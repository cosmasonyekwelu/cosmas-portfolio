...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      git: "https://github.com/cosmasonyekwelu" // a private repo
    },
    {
      id: 3,
      title: "TwitterPlus",
  ...
  return (
    <main className='projects-page container'>
      ...
      <section className='projects-top'>
        ...
        <p className='muted'>Real-world projects showcasing my growth as a full-stack and front-end engineer.</p>
      </section>
